...
class tc_calendar{
	...
	function tc_calendar($objname, $rdc, $date_picker = false, $show_input = true){
		
		$this->objname = $objname . $rdc;
	...
	function writeScript(){
		...
		if($this->date_picker){
			echo("<div style=\"position: relative; margin-left: 5px; width: 119px; z-index: $this->zindex; float: left;\" id=\"container_".$this->objname."\" onmouseover=\"javascript:focusCalendar('$this->objname');\" onmouseout=\"javascript:unFocusCalendar('$this->objname', $this->zindex);\">");
			...
			if($this->show_input){
				...
				echo(" <a style='color:black;' href=\"javascript:toggleCalendar('".$this->objname."', $this->auto_hide, $this->auto_hide_time);\">");
			...
			echo("<img src='calendar/images/iconCalendar.png'\" id=\"tcbtn_".$this->objname."\" name=\"tcbtn_".$this->objname."\" border=\"0\" align=\"absmiddle\" />");
			// }else echo($this->txt);
			echo("</a>");
	...
	function writeDateContainer(){
		...
		if($dd == "1999-11-30"){
			echo("<span id=\"divCalendar_".$this->objname."_lbl\" class=\"date-tccontainer\"".($this->rtl ? " dir=\"rtl\"" : "").">0000-00-00</span>");
		}if($dd == NULL){
			echo("<span id=\"divCalendar_".$this->objname."_lbl\" class=\"date-tccontainer\"".($this->rtl ? " dir=\"rtl\"" : "").">0000-00-00</span>");
